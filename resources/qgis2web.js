...
map.getView().fit([-9330667.959618, 5301807.467366, -9294659.023114, 5328786.829557], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Sipi Resource Map</h2>';
        return titleElement;
    })(),
