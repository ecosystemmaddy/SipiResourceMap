...
var style_TotalDisabledPopulationNoninstitutionalizedAnydisability_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (value >= 0.223000 && value <= 20.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 80.000000 && value <= 93.006000) {
            style = [ new ol.style.Style({
